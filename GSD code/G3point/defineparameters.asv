...
%     [b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z]=readvars([param.ptCloudpathname 'param.csv'],'Range',[inamenum+1 2 inamenum+1 26]);
    [b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z]=readvars(['param.csv'],'Range',[inamenum+1 2 inamenum+1 26]);
...
if param.savegrain==1;    temp = exist('G3point/Grain/','dir');  if temp==0; mkdir('Grain/');  end; end
if param.saveplot==1;     temp = exist('G3point/Figure/','dir'); if temp==0; mkdir('Figure/'); end; end
if param.savegranulo==1;  temp = exist('G3point/Excel/','dir');  if temp==0; mkdir('Excel/');  end; end
...
while grainfolderexist>0 || figurefolderexist>0 || xlsfolderexist>0
    nfolder=nfolder+1;
    param.grainfolder  = ['G3point/Grain/'  param.ptCloudname(1:end-4) '_n' num2str(nfolder) '/'];
    param.figurefolder = ['G3point/Figure/' param.ptCloudname(1:end-4) '_n' num2str(nfolder) '/'];
    param.xlsfolder    = ['G3point/Excel/'  param.ptCloudname(1:end-4) '_n' num2str(nfolder) '/'];    
