...
%% Load full cloud for interpolation 
...
legend('Core Point Precision (no extrapolation)','Location','southeast')

ylim([0.76 0.94])
xtickangle(45)
ylabel('Precision of Extrapolated Cloud')
xlabel('Density (points/m^2)')
%% print plot 
print('A9_DB4Interpolation', '-dpng', '-r400')